  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col">
        {/* Main value with gradient */}
        <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 text-gradient-doser tracking-tight leading-[1.1]">
          {value}
        </div>
      </div>
      {/* Label - fills remaining space and centers content */}
      <div className="flex-1 flex items-center text-xs sm:text-sm font-medium text-doser-text-disabled uppercase tracking-wider">
        <div className="sm:h-[32px]">{label}</div>
      </div>
